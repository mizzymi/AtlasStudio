...
import { setSidebarTab, setShowPreview } from '@/redux/slices/UI/UI.slice';
...
const BuilderPage: React.FC = () => {
  ...
  return (
    <div style={{display:'flex', flexDirection:'column', height:'100vh'}}>
      <TopBar siteName={siteName} onPreview={()=>dispatch(setShowPreview(true))} onExport={()=>exportZip(blocks)} onSettings={()=>{}} />
